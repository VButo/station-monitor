...
function AdvancedPageContent() {
  ...
  // Create a single instance of the data grid to avoid duplicate rendering
  ...
  return (
    <div className="h-full bg-gray-50 flex flex-col">
      ...
      <div className="hidden lg:block">
        <div className={`flex gap-4 ${showColumnSelector ? '' : 'block'}`}>
      ...
      {/* Mobile Table with Column Selector Dropdown */}
